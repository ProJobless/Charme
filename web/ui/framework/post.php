...
function comment_format($commentId, $userid, $username, $content, $time)
{
    ...
    return "<div class='comment'><a onlick='deleteComment(\"".$commentId['$id']."\")' class='delete'> </a><div class='head'>$usid</div>$content</div>";
}
...
if (isset($obj["typ"]) && $obj["typ"]==2)
{
	...
	return array("<a onclick='showPhoto(\"".$obj["_id"]."\", \"".$obj["userid"]."\")'><img src='apl/fs/?i=".$obj["reference"]."'></a>", 1);
}
else
{
